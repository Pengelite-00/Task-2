...
namespace GoblinGame
{
    ...
    public class Map
    {
        ...
        public void PopulateEmptyTiles()               //Creation of empty tiles
        {
            for (int i = 0; i < mapWidth; i++)
            {
        ...
        public Item GetItemAtPosition(int X, int Y)         //Method for checking if theres an item when moving
        {
            Item itempickup = null;
